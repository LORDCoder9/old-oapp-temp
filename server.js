...
class io_andwehavekilledhim extends IO {
    constructor(body) {
        super(body);
    }

    think() {
      this.body.health.max = Infinity
      this.body.health.amount = Infinity
      if (Math.random() <= 0.1) {
        ...
        connect: (() => {
            ...
            const spawn = (() => {
                ...
                return (socket, name) => {
                    ...
                    let body = new Entity({x:150, y:150});
...
//Lag
//let death = new Entity({
  //x: 700,
  //y: 700
//})
//death.define(Class.godisdead)